...
export type ConnextEthSwapEvent = TypedEvent<
...
export type ConnextEthSwapEventFilter = TypedEventFilter<ConnextEthSwapEvent>;

export type ConnextInitializedEvent = TypedEvent<
  [string, number, string],
  { connext: string; domainId: number; weth: string }
>;
