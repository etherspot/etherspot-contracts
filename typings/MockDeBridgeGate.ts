...
export interface MockDeBridgeGateInterface extends utils.Interface {
  functions: {
    ...
    "getSubmissionId(bytes32,uint256,uint256,uint256,address,uint256)": FunctionFragment;
    ...
    "initializeMock(uint8,address,address,address,address,address,address,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getSubmissionId",
    values: [
      BytesLike,
      BigNumberish,
      BigNumberish,
  ...
  encodeFunctionData(
    functionFragment: "initializeMock",
    values: [
      BigNumberish,
      string,
      string,
...
export interface MockDeBridgeGate extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockDeBridgeGateInterface;
