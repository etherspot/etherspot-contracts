...
export interface AccountImplementationV1MockInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "c_false3fd0a446",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "c_true3fd0a446",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "c_3fd0a446", data: BytesLike): Result;
...
export interface AccountImplementationV1Mock extends BaseContract {
  ...
  c_3fd0a446(c__3fd0a446: BytesLike, overrides?: CallOverrides): Promise<void>;
