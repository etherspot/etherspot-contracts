...
export interface PersonalAccountRegistryInterface extends utils.Interface {
  functions: {
    ...
    "c_279b00a1(bytes8)": FunctionFragment;
    ...
    "c_false279b00a1(bytes8)": FunctionFragment;
    ...
    "c_true279b00a1(bytes8)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "c_false279b00a1",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "c_true279b00a1",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "c_279b00a1", data: BytesLike): Result;
...
export type AccountCallRefundedEvent = TypedEvent<
  ...
  { account: string; beneficiary: string; token: string; value: BigNumber }
>;
...
export interface PersonalAccountRegistry extends BaseContract {
  ...
  c_279b00a1(c__279b00a1: BytesLike, overrides?: CallOverrides): Promise<void>;
