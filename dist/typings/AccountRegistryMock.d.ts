...
export interface AccountRegistryMockInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "c_5dbd0fc3", values: [BytesLike]): string;
    encodeFunctionData(functionFragment: "c_false203cf0ac", values: [BytesLike]): string;
    encodeFunctionData(functionFragment: "c_false5dbd0fc3", values: [BytesLike]): string;
    encodeFunctionData(functionFragment: "c_true203cf0ac", values: [BytesLike]): string;
    encodeFunctionData(functionFragment: "c_true5dbd0fc3", values: [BytesLike]): string;
    encodeFunctionData(functionFragment: "isValidAccountSignature", values: [string, BytesLike, BytesLike]): string;
    encodeFunctionData(functionFragment: "mockAccountOwners", values: [string, string[]]): string;
    ...
    decodeFunctionResult(functionFragment: "c_false5dbd0fc3", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "c_true203cf0ac", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "c_true5dbd0fc3", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "isValidAccountSignature", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "mockAccountOwners", data: BytesLike): Result;
    events: {};
}
export interface AccountRegistryMock extends BaseContract {
    ...
    functions: {
        ...
        c_false5dbd0fc3(c__5dbd0fc3: BytesLike, overrides?: CallOverrides): Promise<[boolean]>;
        c_true203cf0ac(c__203cf0ac: BytesLike, overrides?: CallOverrides): Promise<[boolean]>;
        c_true5dbd0fc3(c__5dbd0fc3: BytesLike, overrides?: CallOverrides): Promise<[boolean]>;
        ...
        mockAccountOwners(account: string, owners: string[], overrides?: Overrides & {
    ...
    callStatic: {
        ...
        "isValidAccountSignature(address,bytes,bytes)"(account: string, message: BytesLike, signature: BytesLike, overrides?: CallOverrides): Promise<boolean>;
        "isValidAccountSignature(address,bytes32,bytes)"(account: string, messageHash: BytesLike, signature: BytesLike, overrides?: CallOverrides): Promise<boolean>;
        mockAccountOwners(account: string, owners: string[], overrides?: CallOverrides): Promise<void>;
    };
    filters: {};
    estimateGas: {
        c_203cf0ac(c__203cf0ac: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        c_5dbd0fc3(c__5dbd0fc3: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        c_false203cf0ac(c__203cf0ac: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        c_false5dbd0fc3(c__5dbd0fc3: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        c_true203cf0ac(c__203cf0ac: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        c_true5dbd0fc3(c__5dbd0fc3: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        c_5dbd0fc3(c__5dbd0fc3: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        c_false203cf0ac(c__203cf0ac: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        c_false5dbd0fc3(c__5dbd0fc3: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        c_true203cf0ac(c__203cf0ac: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        c_true5dbd0fc3(c__5dbd0fc3: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
