...
export interface HomeInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "improperUpdate", values: [BytesLike, BytesLike, BytesLike]): string;
    ...
    encodeFunctionData(functionFragment: "queueContains", values: [BytesLike]): string;
    encodeFunctionData(functionFragment: "queueEnd", values?: undefined): string;
    encodeFunctionData(functionFragment: "queueLength", values?: undefined): string;
    encodeFunctionData(functionFragment: "renounceOwnership", values?: undefined): string;
    encodeFunctionData(functionFragment: "root", values?: undefined): string;
    encodeFunctionData(functionFragment: "setUpdater", values: [string]): string;
    encodeFunctionData(functionFragment: "setUpdaterManager", values: [string]): string;
    encodeFunctionData(functionFragment: "state", values?: undefined): string;
    encodeFunctionData(functionFragment: "suggestUpdate", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "updaterManager", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "improperUpdate", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "initialize", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "localDomain", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "nonces", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "owner", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "queueContains", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "queueEnd", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "queueLength", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "renounceOwnership", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "root", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setUpdater", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setUpdaterManager", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "state", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "suggestUpdate", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "updaterManager", data: BytesLike): Result;
    events: {
...
export declare type ImproperUpdateEvent = TypedEvent<[
    string,
    string,
    string
], {
...
export declare type ImproperUpdateEventFilter = TypedEventFilter<ImproperUpdateEvent>;
...
export declare type NewUpdaterManagerEvent = TypedEvent<[
    string
], {
    updaterManager: string;
}>;
export declare type NewUpdaterManagerEventFilter = TypedEventFilter<NewUpdaterManagerEvent>;
...
export declare type UpdaterSlashedEvent = TypedEvent<[
    string,
    string
], {
    updater: string;
...
export declare type UpdaterSlashedEventFilter = TypedEventFilter<UpdaterSlashedEvent>;
export interface Home extends BaseContract {
    ...
    functions: {
        ...
        improperUpdate(_oldRoot: BytesLike, _newRoot: BytesLike, _signature: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        initialize(_updaterManager: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        setUpdaterManager(_updaterManager: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        state(overrides?: CallOverrides): Promise<[number]>;
        suggestUpdate(overrides?: CallOverrides): Promise<[string, string] & {
            _committedRoot: string;
            _new: string;
        }>;
        ...
        update(_committedRoot: BytesLike, _newRoot: BytesLike, _signature: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        homeDomainHash(overrides?: CallOverrides): Promise<string>;
        improperUpdate(_oldRoot: BytesLike, _newRoot: BytesLike, _signature: BytesLike, overrides?: CallOverrides): Promise<boolean>;
        initialize(_updaterManager: string, overrides?: CallOverrides): Promise<void>;
        localDomain(overrides?: CallOverrides): Promise<number>;
        nonces(arg0: BigNumberish, overrides?: CallOverrides): Promise<number>;
        owner(overrides?: CallOverrides): Promise<string>;
        queueContains(_item: BytesLike, overrides?: CallOverrides): Promise<boolean>;
        ...
        setUpdaterManager(_updaterManager: string, overrides?: CallOverrides): Promise<void>;
        state(overrides?: CallOverrides): Promise<number>;
        suggestUpdate(overrides?: CallOverrides): Promise<[string, string] & {
            _committedRoot: string;
            _new: string;
        ...
        tree(overrides?: CallOverrides): Promise<BigNumber>;
        update(_committedRoot: BytesLike, _newRoot: BytesLike, _signature: BytesLike, overrides?: CallOverrides): Promise<void>;
        updater(overrides?: CallOverrides): Promise<string>;
        updaterManager(overrides?: CallOverrides): Promise<string>;
    };
    filters: {
        "Dispatch(bytes32,uint256,uint64,bytes32,bytes)"(messageHash?: BytesLike | null, leafIndex?: BigNumberish | null, destinationAndNonce?: BigNumberish | null, committedRoot?: null, message?: null): DispatchEventFilter;
        Dispatch(messageHash?: BytesLike | null, leafIndex?: BigNumberish | null, destinationAndNonce?: BigNumberish | null, committedRoot?: null, message?: null): DispatchEventFilter;
        ...
        "ImproperUpdate(bytes32,bytes32,bytes)"(oldRoot?: null, newRoot?: null, signature?: null): ImproperUpdateEventFilter;
        ImproperUpdate(oldRoot?: null, newRoot?: null, signature?: null): ImproperUpdateEventFilter;
        ...
        "UpdaterSlashed(address,address)"(updater?: string | null, reporter?: string | null): UpdaterSlashedEventFilter;
        UpdaterSlashed(updater?: string | null, reporter?: string | null): UpdaterSlashedEventFilter;
    };
    estimateGas: {
        MAX_MESSAGE_BODY_BYTES(overrides?: CallOverrides): Promise<BigNumber>;
        ...
        queueContains(_item: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        queueContains(_item: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
