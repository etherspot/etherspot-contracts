...
export interface PersonalAccountImplementationV1Interface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "c_d5fdf5ee", values: [BytesLike]): string;
    ...
    encodeFunctionData(functionFragment: "c_falsed5fdf5ee", values: [BytesLike]): string;
    ...
    encodeFunctionData(functionFragment: "c_trued5fdf5ee", values: [BytesLike]): string;
    ...
    decodeFunctionResult(functionFragment: "c_d5fdf5ee", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "c_falsed5fdf5ee", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "c_trued5fdf5ee", data: BytesLike): Result;
...
export interface PersonalAccountImplementationV1 extends BaseContract {
    ...
    functions: {
        ...
        c_d5fdf5ee(c__d5fdf5ee: BytesLike, overrides?: CallOverrides): Promise<[void]>;
        ...
        c_falsed5fdf5ee(c__d5fdf5ee: BytesLike, overrides?: CallOverrides): Promise<[boolean]>;
        ...
        c_trued5fdf5ee(c__d5fdf5ee: BytesLike, overrides?: CallOverrides): Promise<[boolean]>;
    ...
    estimateGas: {
        ...
        c_d5fdf5ee(c__d5fdf5ee: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        ...
        c_falsed5fdf5ee(c__d5fdf5ee: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        ...
        c_trued5fdf5ee(c__d5fdf5ee: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        c_d5fdf5ee(c__d5fdf5ee: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        c_falsed5fdf5ee(c__d5fdf5ee: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        c_trued5fdf5ee(c__d5fdf5ee: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
