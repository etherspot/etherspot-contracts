...
export interface PersonalAccountImplementationV1Interface extends utils.Interface {
    functions: {
...
export interface PersonalAccountImplementationV1 extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: PersonalAccountImplementationV1Interface;
