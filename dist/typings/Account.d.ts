...
export interface AccountInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "c_d6b1085a", values: [BytesLike]): string;
    encodeFunctionData(functionFragment: "c_e208e0f4", values: [BytesLike]): string;
    encodeFunctionData(functionFragment: "c_false305923d6", values: [BytesLike]): string;
    encodeFunctionData(functionFragment: "c_falsed6b1085a", values: [BytesLike]): string;
    ...
    encodeFunctionData(functionFragment: "c_trued6b1085a", values: [BytesLike]): string;
    ...
    decodeFunctionResult(functionFragment: "c_false305923d6", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "c_falsed6b1085a", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "c_trued6b1085a", data: BytesLike): Result;
...
export interface Account extends BaseContract {
    ...
    functions: {
        ...
        c_false305923d6(c__305923d6: BytesLike, overrides?: CallOverrides): Promise<[boolean]>;
        c_falsed6b1085a(c__d6b1085a: BytesLike, overrides?: CallOverrides): Promise<[boolean]>;
        ...
        c_trued6b1085a(c__d6b1085a: BytesLike, overrides?: CallOverrides): Promise<[boolean]>;
    ...
    estimateGas: {
        ...
        c_d6b1085a(c__d6b1085a: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        c_e208e0f4(c__e208e0f4: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        c_false305923d6(c__305923d6: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        c_falsed6b1085a(c__d6b1085a: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        ...
        c_trued6b1085a(c__d6b1085a: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        c_d6b1085a(c__d6b1085a: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        c_e208e0f4(c__e208e0f4: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        c_false305923d6(c__305923d6: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        c_falsed6b1085a(c__d6b1085a: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        c_trued6b1085a(c__d6b1085a: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
