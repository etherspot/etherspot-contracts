...
export declare class SwapUtils__factory extends ContractFactory {
    ...
    static readonly bytecode = "0x602d6050600b82828239805160001a6073146043577f4e487b7100000000000000000000000000000000000000000000000000000000600052600060045260246000fd5b30600052607381538281f3fe73000000000000000000000000000000000000000030146080604052600080fdfea164736f6c634300080b000a";
    static readonly abi: {
        anonymous: boolean;
        inputs: {
            indexed: boolean;
