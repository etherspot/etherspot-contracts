...
export declare type SubNodeRegistrationStructOutput = [
  string,
  string,
  string,
] & {
...
export interface ENSControllerInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "c_falsea2a35eda",
    values: [BytesLike],
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "c_falsee1dc25ce",
    values: [BytesLike],
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "c_truea2a35eda",
    values: [BytesLike],
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "c_truee1dc25ce",
    values: [BytesLike],
  ): string;
...
>;
export declare type AddressChangedEventFilter = TypedEventFilter<
  AddressChangedEvent
>;
...
>;
export declare type GuardianAddedEventFilter = TypedEventFilter<
  GuardianAddedEvent
>;
...
>;
export declare type GuardianRemovedEventFilter = TypedEventFilter<
...
>;
export declare type NodeReleasedEventFilter = TypedEventFilter<
  NodeReleasedEvent
>;
...
>;
export declare type NodeSubmittedEventFilter = TypedEventFilter<
  NodeSubmittedEvent
>;
export declare type NodeVerifiedEvent = TypedEvent<
  [string],
  {
    node: string;
  }
>;
export declare type NodeVerifiedEventFilter = TypedEventFilter<
  NodeVerifiedEvent
>;
...
>;
export declare type PubkeyChangedEventFilter = TypedEventFilter<
  PubkeyChangedEvent
>;
export declare type RegistryChangedEvent = TypedEvent<
  [string],
  {
    registry: string;
  }
>;
export declare type RegistryChangedEventFilter = TypedEventFilter<
